...
<section class="barra de nav">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">terminos y usos</a> <!-- solo texto  --> 
                </li>
    ...
    <section class="seccion-carrusel">
        <div class="titulo">
            ...
            <section >
                <div class="container">
                    <p class="h1 text-center fw-bold fst-italic text-white">
                    ...
                    <p class="text-md-start text-white">
        ...
        <footer class="text-center text-lg-start text-white" style="background-color: #1c2331">
                    ...
                    <!-- Left -->
                    <div class="me-5">
                        <span>Conecta con nosotros a traves de nuestras redes:</span>
                    </div>
                    <!-- Left -->
                    ...
                    <div class="container text-center text-md-start mt-5">
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                            <!-- Content -->
                            <h6 class="text-uppercase fw-bold">Games For All</h6>
                            <hr
